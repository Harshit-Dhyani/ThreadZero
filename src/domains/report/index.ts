...
function relinkEvidenceForReport(state: ReportState) {
  ...
  if (state.reportKind === "financial") link(["payment-receipt", "transaction-reference", "upi-id", "account-id"], "event-payment");
}
...
export function reportPresentation(report: ReportState, language: Language) {
  ...
  return {
    ...
    timeline: { title: hi ? "तथ्यों की सरल समयरेखा बनाएं" : "Build a simple factual timeline", intro: hi ? "पहला संकेत, उपलब्ध रिकॉर्ड और आगे उठाए गए कदम क्रम में रखें।" : "Order the first sign, the records you have, and what happened next." },
    review: { label, title: hi ? "तथ्य-आधारित तैयारी की समीक्षा करें" : "Review your fact-first preparation", intro: hi ? "श्रेणी का अनुमान लगाने के बजाय उपलब्ध तथ्य, साक्ष्य और समयरेखा जाँचें।" : "Check the facts, evidence, and timeline without guessing a category.", nextAction: officialNextStep(report, hi) }
  };
}
