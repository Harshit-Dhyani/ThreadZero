...
export function LearningV74() {
  ...
  return <LandingFrame route={route}>
    ...
    <section className="mt-9" aria-labelledby="learning-needs-title">
...
export function HelpV74() {
  ...
  return <LandingFrame route={route}>
    ...
    <section className="mt-7 overflow-hidden rounded-special border border-[#f1c6c2] bg-[#fff8f6] p-5 sm:p-6" aria-labelledby="immediate-help-title">
