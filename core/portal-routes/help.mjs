export const HELP_ROUTES = [
  ...
  },
  {
    ...
    "intro": {
      "en": "Use local guidance first; official nodal and grievance details remain in the Sources panel.",
      "hi": "पहले स्थानीय मार्गदर्शन उपयोग करें; आधिकारिक नोडल और शिकायत विवरण स्रोत पैनल में हैं।"
    },
    "items": [
      {
        "title": {
      ...
      },
      {
        "title": {
          "en": "Portal feedback",
          "hi": "पोर्टल प्रतिक्रिया"
        },
        "body": {
          "en": "Send feedback to this local simulation.",
          "hi": "इस स्थानीय सिमुलेशन को प्रतिक्रिया दें।"
        },
        "route": "feedback"
      },
      {
  ...
  },
  {
    ...
    "intro": {
      "en": "Feedback stays in memory and disappears on reload.",
      "hi": "प्रतिक्रिया मेमोरी में रहती है और रीलोड पर मिट जाती है।"
    },
    "items": [],
    "fields": [
      {
